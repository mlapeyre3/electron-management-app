            ...
            <div class="field">
                <div class="two fields">
                    ...
                    <div class="field">
                        ...
                        <multiselect v-model="userSelected" :options="userList" track-by="key" label="displayName" placeholder="Pick some" :multiple="true" :close-on-select="false" :clear-on-select="false" :hide-selected="true" :searchable="false"></multiselect>
                    </div>
                </div>
            </div>
            <div class="ui primary button" tabindex="0" @click="fetchWorklog(dateRangeSelected,userSelected)">Compute Worklog</div>
        </form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addUserWorklog: function(userList,issueList) {
